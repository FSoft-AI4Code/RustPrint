...
def parse_args():
    ...
    parser.add_argument("--generated-dir", help="Directory containing generated documentation and evaluation_results")
...
def main():
    ...
    if args.generated_dir:
        eval_results_dir = os.path.join(args.generated_dir, "evaluation_results")
        results_file = args.results_file or os.path.join(eval_results_dir, "combined_evaluation_results.json")
    else:
