    ...
    def handle_api_error(
        ...
        if "429" in error_message or "rate limit" in error_message.lower():
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Verify your API key: rustprint config show\n"
                "  2. Update your API key: rustprint config set --api-key <new-key>\n"
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Check your internet connection\n"
                "  2. Verify the base URL: rustprint config show\n"
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Check your configuration: rustprint config show\n"
