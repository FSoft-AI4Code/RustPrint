...
from rustprint.cli.utils.errors import RepositoryError
from rustprint.cli.utils.validation import validate_repository_path, detect_supported_languages
...
def validate_repository(repo_path: Path) -> Tuple[Path, List[Tuple[str, int]]]:
    ...
    if not languages:
        raise RepositoryError(
            ...
            "RustPrint supports: Python, Java, JavaScript, TypeScript, C, C++, C#, Rust\n\n"
