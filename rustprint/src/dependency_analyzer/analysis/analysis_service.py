...
from rustprint.src.dependency_analyzer.utils.security import safe_open_text, assert_safe_path
from rustprint.src.dependency_analyzer.analysis.repo_analyzer import RepoAnalyzer
from rustprint.src.dependency_analyzer.analysis.call_graph_analyzer import CallGraphAnalyzer
from rustprint.src.dependency_analyzer.analysis.cloning import clone_repository, cleanup_repository, parse_github_url
from rustprint.src.dependency_analyzer.models.analysis import AnalysisResult
from rustprint.src.dependency_analyzer.models.core import Repository
...
class AnalysisService:
    ...
    def _get_supported_languages(self) -> List[str]:
        ...
        return ["python", "javascript", "typescript", "java", "csharp", "c", "cpp", "rust"]
