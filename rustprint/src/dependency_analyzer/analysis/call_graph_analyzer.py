...
from rustprint.src.dependency_analyzer.utils.patterns import CODE_EXTENSIONS
from rustprint.src.dependency_analyzer.utils.security import safe_open_text
...
class CallGraphAnalyzer:
    ...
    def _analyze_c_file(self, file_path: str, content: str, repo_dir: str):
        ...
        """
        from rustprint.src.dependency_analyzer.analyzers.c import analyze_c_file
    ...
    def _analyze_rust_file(self, file_path: str, content: str, repo_dir: str):
        ...
        Args:
            ...
            repo_dir: Repository base directory
        """
        from rustprint.src.dependency_analyzer.analyzers.rust import analyze_rust_file
